...
func main() {
	solver := wordchainsresolver.NewAStarSolver()
	factory := wordchainsresolver.NewFileLoaderFactory(os.Getenv("GOPATH") + "/src/github.com/clnbs/wordChains/assets/app/small_en.txt")
